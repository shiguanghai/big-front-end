...
export { classDisplayNameHandler, classMethodHandler, classPropHandler, componentHandler, displayNameHandler, eventHandler, extendsHandler, methodHandler, mixinsHandler, propHandler, slotHandler, slotHandlerFunctional, slotHandlerLitteral };
declare const defaultHandlers: Handler[];
export declare const preHandlers: Handler[];
